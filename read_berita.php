...
if($result->num_rows > 0){
    ...
    while($row = $result->fetch_assoc()) {
        ...
        $cart[] = (object) ['id' => $row['id'], 'tanggal' => $row['Tanggal'], 'waktu' => $row['Waktu'], 'judul' => $row['Judul'], 'gambar_1' => $row['Gambar_1'], 'isi_1' => $isi_1, 'gambar_2' => $row['Gambar_2'], 'isi_2' => $isi_2];
    }
